...
//Bin Heuristic
#define BIN_LENGTH_LINEAR_INCREASE 8
#define BIN_LENGTH_LINEAR_DECREASE 16 
...
//CAPEST Macros
#define REPEAT_BIN(x) x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;x;  
