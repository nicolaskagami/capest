...
def main():
    ...
    def runTest(method,nom_cap,num_videos):
        ...
        h2.cmd('ping 10.0.4.10 -i 0.2 -c 75 -q -s 0 > /dev/null &')
        sleep(30)
        capest.kill()
    ...
    def runBatch(repetitions):
        for x in range(0,repetitions):
            runTest("Accuracy_capest32_256",8000,1000)
            runTest("Accuracy_capest32_256",8000,2000)
            runTest("Accuracy_capest32_256",8000,3000)
            runTest("Accuracy_capest32_256",8000,4000)
            runTest("Accuracy_capest32_256",8000,5000)
            runTest("Accuracy_capest32_256",8000,6000)
            runTest("Accuracy_capest32_256",8000,7000)
            runTest("Accuracy_capest32_256",16000,1000)
            runTest("Accuracy_capest32_256",16000,2000)
            runTest("Accuracy_capest32_256",16000,3000)
            runTest("Accuracy_capest32_256",16000,4000)
            runTest("Accuracy_capest32_256",16000,5000)
            runTest("Accuracy_capest32_256",16000,6000)
            runTest("Accuracy_capest32_256",16000,7000)
