...
def main():
    ...
    def runBatch(repetitions):
        for x in range(0,repetitions):
            runTest("Video_"+args.json,4000,1)
            runTest("Video_"+args.json,6000,1)
            runTest("Video_"+args.json,6000,2)
            runTest("Video_"+args.json,8000,1)
            runTest("Video_"+args.json,8000,3)
            runTest("Video_"+args.json,10000,2)
            runTest("Video_"+args.json,10000,4)
            runTest("Video_"+args.json,12000,1)
            runTest("Video_"+args.json,12000,5)
            runTest("Video_"+args.json,14000,1)
            runTest("Video_"+args.json,14000,5)
            runTest("Video_"+args.json,14000,6)
            runTest("Video_"+args.json,16000,1)
            runTest("Video_"+args.json,16000,6)
            runTest("Video_"+args.json,16000,7)
